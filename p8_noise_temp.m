...
gain = nrao_g + cable_g + quin_g + lorch_g + miteq_g + n_amps*zx60_g + poly_g ...
       + dcblk_g + aaf_g + coup_g;

% friis equation!
temperature = nrao_t +...
    cable_t/nrao_pw +...
    quin_t/(nrao_pw*cable_pw) +...
    lorch_t/(nrao_pw*quin_pw*cable_pw) +...
    miteq_t/(nrao_pw*quin_pw*lorch_pw*cable_pw) +...
    zx60_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*cable_pw) +...
    zx60_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw*cable_pw) +...
    zx60_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw^2*cable_pw) +...
    poly_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw^3*cable_pw) +...
    dcblk_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw^3*poly_pw*cable_pw) +...
    aaf_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw^3*poly_pw*dcblk_pw*cable_pw) +...
    coup_t/(nrao_pw*quin_pw*lorch_pw*miteq_pw*zx60_pw^3*poly_pw*dcblk_pw*aaf_pw*cable_pw);
end